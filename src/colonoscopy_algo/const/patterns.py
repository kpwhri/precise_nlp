...
ind = r'indications?:'
isayo = r'\s*is\s*a\s*\d{2,3}\s*year\s*old'
screen = r'(for|cancer)? screening'
occult = r'positive\s*((hema?)?occult|fit|g?fobt)'
abnormal = r'abnormal'
...
weight = r'(weight|wt)\s*loss|anorexi'
mets = r'metasta'
suspect = r'suspect'
colitis = r'colitis'
divertic = r'divertic'
ibd1 = r'\bibd|uc\b'
ibd2 = r'ulcerative|crohn|inflammatory\s*bowel|pan(\s|-)*colitis'
perhx = r'(?<!family\s)(?<!family)(((history|hsitory|hx)\s*of)|h\/o)'
famhx = r'family|famhx|mother|father|sister|brother|\bFH\b'
genetic = r'fap|lynch|hnpcc'
followup = r'follow\s*-?\s*up|f\/u'
